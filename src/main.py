...
documents = ['barack.txt', 'elon.txt', 'linus.txt', 'einstein.txt', 'william.txt']
file_content = [1, 2, 3, 4, 5]
tokens = file_content
titles = ['Barack Obama', 'Elon Musk', 'Linus Torvalds', 'Albert Einstein', 'William Shakespeare']
...
#sep = ' '.join(obj.similarities(q_tok))
